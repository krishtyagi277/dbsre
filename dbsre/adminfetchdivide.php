...
{ if($row["Type"]=="user"){
 $sub_array = array();
  ...
  $sub_array[] = '<div class="update" data-id="'.$row["id"].'" data-column="Created_at">' . $row["Created_at"] . '</div>'; 
   $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="row_start">' . $row["row_start"] . '</div>'; 
    $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="row_end">' . $row["row_end"] . '</div>'; 
